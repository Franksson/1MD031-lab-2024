...
<header>
    ...
    <main>
      ...
      <section class="order-info">
        ...
        <p>
          Please enter delivery information below so we can find you. And we
          will feed you.
        </p>
        <h3>Delivery Information</h3>
        <p>
          <label for="fullname">Full Name</label>
          <input required v-model="order.name" placeholder="First and last name" />
        </p>
        <p>
        ...
        <fieldset>
          ...
          <input type="radio" v-model="order.gender" value="Non-binary" id="nonbinary" />
